...
while main:
    ...
    # räkna ut delta Y och delta X för att räkna ut grejer med AI med hjälp av lista med gamla värden och nya värden på x o y för bollen
    ...
    while game:
        ...
        if paddlePosY < circlePosY: # keys[pygame.K_w] or keys[pygame.K_UP]:  # vad händer om man trycker på pil upp eller w
        ...
        elif paddlePosY > circlePosY: # keys[pygame.K_s] or keys[pygame.K_DOWN]:
            if paddlePosY > 440:
                paddlePosY = 440
            elif paddlePosY < 10:
                paddlePosY = 10
...
# ------------------------------------------ #
        ...
        if circlePosX > 250:
            with open('AI_values.csv', mode='a', newline='') as file:
                writer = csv.writer(file)
                writer.writerow([circlePosX, circlePosY, values[0], values[1], dX, dY, paddlePosY])
