...
training_data = [
    [54.4, 14.4, 'Kylrum'], [45.4, 12.4, 'Kylrum'], [89.4, 19.5, 'Klassrum'],
    [57.4, 18.1, 'Lärarrum'], [22.4, 8.6, 'Kylrum'], [24.4, 11.24, 'Kylrum'],
    [84.4, 24.4, 'Klassrum'], [95.4, 22.4, 'Klassrum'], [81.4, 20.1, 'Lärarrum'],
    [70, 19.7, 'Lärarrum'], [70, 19.8, 'Klassrum'], [30.7, 3.5, 'Kylrum'],
    [73.5, 19.8, 'Klassrum'], [67.4, 18.9, 'Lärarrum']
]
...
header = ["luftfuktighet", "temperatur", "rum"]
