...
class Ball:
    def __init__(self, color, width, height):
        ...
        self.image = pygame.draw.circle(screen, (0, 0, 0), (circlePosX, circlePosY), 2*radius)
...
while main:
    ...
    while game:
        ...
        AI = pygame.draw.rect(screen, Color, (470, AIpaddlePosY, 10, 50)) # (x kordinat, y kordinat, bredd, längd)
        ...
        screen.blit(printPoint, (200 - printPoint.get_width() //2, 550 - printPoint.get_height() // 2))
        screen.blit(printPointAI, (300 - printPointAI.get_width() //2, 550 - printPointAI.get_height() // 2))
...
# ------------------------------------------ #
    ...
    if AIpoints == 5 or playerPoints == 5:
        if AIpoints == 5:
            screen.blit(lossText,(250 - lossText.get_width() // 2, 250 - lossText.get_height() // 2))
        
        elif playerPoints == 5:
            screen.blit(winText, (250 - winText.get_width() //2, 250 - winText.get_height() // 2))
        
        else:
            screen.blit(drawText, (250 - drawText.get_width() //2, 250 - drawText.get_height() // 2))
